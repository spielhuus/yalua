...
TESTS_CHAPTER_SEVEN = "CT4Q,C2DT,T4YY,9TFX,PRH3,FRK4,DFF7,QF4Y,4GC6,HS5T,8UDB,NP9H,WZ62,7A4E,Q8AD,SSW6,5KJE,Q88A,9MMW,87E4,DBG4,LQZ7,3GZX,LE5A,5C5M,L9U5"
...
test: $(LUA_FILES) $(SPEC_FILES) ## Run the tests
	...
	# last test is 2.11
	busted spec/testsuite/tree_spec.lua --tags $(TESTS_CHAPTER_TWO),$(TESTS_CHAPTER_FIVE),$(TESTS_CHAPTER_SIX),$(TESTS_CHAPTER_SEVEN)

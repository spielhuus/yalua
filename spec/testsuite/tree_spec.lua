...
describe("Run the YAML test #suite, compare with TREE", function()
	...
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		...
		local input = load_file("./yaml-test-suite/data/Y79Y/00/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/01/in.yaml")
		local tree = load_file("./yaml-test-suite/data/Y79Y/01/test.event")
		local result = yalua.stream(input)
		assert.is.Same(tree, remove_all_trailing_spaces(result))
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/02/in.yaml")
		local tree = load_file("./yaml-test-suite/data/Y79Y/02/test.event")
		local result = yalua.stream(input)
		assert.is.Same(tree, remove_all_trailing_spaces(result))
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/03/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/04/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/05/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/06/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/07/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/08/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/09/in.yaml")
		local result = yalua.stream(input)
		assert.Equal(nil, result)
	end)
	it("should parse the Tabs in various contexts, file: #Y79Y tags: #whitespace", function()
		print("### should parse the Tabs in various contexts, file: #Y79Y")
		local input = load_file("./yaml-test-suite/data/Y79Y/10/in.yaml")
		local tree = load_file("./yaml-test-suite/data/Y79Y/10/test.event")
		local result = yalua.stream(input)
		assert.is.Same(tree, remove_all_trailing_spaces(result))
	end)
